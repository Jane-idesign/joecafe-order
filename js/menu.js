...
window.MENU = {
  ...
  items: [
    ...
    { id: "cf-americano", cat: "coffee", name: "美式咖啡", en: "Americano", price: 180 },
    { id: "cf-latte", cat: "coffee", name: "拿鐵咖啡", en: "Latte", price: 200, img: "img/latte.jpg" },
    { id: "cf-cappuccino", cat: "coffee", name: "卡布其諾咖啡", en: "Cappuccino", price: 200 },
    { id: "cf-macchiato", cat: "coffee", name: "焦糖瑪奇朵咖啡", en: "Caramel Macchiato", price: 220 },
    { id: "cf-mocha", cat: "coffee", name: "摩卡巧克力咖啡", en: "Mocha", price: 220 },
    { id: "cf-vienna", cat: "coffee", name: "維也納咖啡", en: "Vienna Coffee", price: 200, img: "img/vienna.jpg" },
    { id: "cf-baileys", cat: "coffee", name: "招牌奶酒咖啡", en: "Bailey's Coffee", price: 250 },

    // 茶
    { id: "tea-fruit", cat: "tea", name: "夏日鮮果茶", en: "Summer Fruit Tea", price: 240, img: "img/fruit-tea.jpg" },
    { id: "tea-longan", cat: "tea", name: "桂圓枸杞紅棗茶", en: "Longan, Goji & Red Date Tea", price: 250, tag: "熱壺", img: "img/longan-tea.jpg" },
    { id: "tea-ginger", cat: "tea", name: "枸杞薑絲紅棗茶", en: "Goji, Ginger & Red Date Tea", price: 250, tag: "熱壺", img: "img/goji-ginger-tea.jpg" },
    { id: "tea-oolong", cat: "tea", name: "高山烏龍茶", en: "High Mountain Oolong Tea", price: 220, tag: "熱壺" },
    { id: "tea-flower", cat: "tea", name: "雲間子花茶", en: "Mystery Flower Tea", price: 200, tag: "熱壺" },
    { id: "tea-black", cat: "tea", name: "招牌紅茶", en: "Signature Black Tea", price: 200, img: "img/black-tea.jpg" },
    { id: "tea-bubble", cat: "tea", name: "黑糖珍珠鮮奶茶", en: "Brown Sugar Bubble Milk Tea", price: 250 },
    { id: "tea-matcha", cat: "tea", name: "抹茶珍珠鮮奶茶", en: "Matcha Bubble Milk Tea", price: 250 },
    { id: "tea-earlgrey", cat: "tea", name: "伯爵鮮奶茶", en: "Earl Grey Milk Tea", price: 200 },
    { id: "tea-gingermilk", cat: "tea", name: "暖薑鮮奶茶", en: "Ginger Milk Tea", price: 200 },
    { id: "tea-cocoa", cat: "tea", name: "鮮奶可可", en: "Milk Cocoa", price: 220, img: "img/cocoa.jpg" },

    // 其他飲品
    { id: "ot-juice", cat: "other", name: "季節現打高纖蔬果汁", en: "Seasonal Fresh Juice", price: 250 },
    { id: "ot-sparkling", cat: "other", name: "綜合水果氣泡飲", en: "Fruit Sparkling Drink", price: 220 },
    { id: "ot-beer", cat: "other", name: "季節水果啤酒", en: "Seasonal Fruit Beer", price: 250 },
